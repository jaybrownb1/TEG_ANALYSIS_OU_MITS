...
const byte rxPin = 3;  // RX pin is physical pin 3
const byte txPin = 4;  // TX pin is physical pin 4

const byte ultrasonicPin = 5; // Assuming you are using pin 5 for ultrasonic, modify as needed
...
void setup(void) {
  ...
  pinMode(rxPin, INPUT);  // Define pin modes for RX and TX
